    ...
    \begin{description}
        ...
        \begin{center}
            \begin{tikzcd}[row sep=large, column sep=large]
              ...
              &  &  &(x \otimes x) \otimes m\ar[dd, "\Id_x \otimes \rho"]  \\
...
\begin{mydef}[label=def:bomodobj,breakable]{両側加群}
    \hyperref[def:tensorfusion-cat]{多重テンソル圏} $(\Cat{C},\, \otimes,\, 1,\, a,\, l,\, r,\, \lev,\, \lcoev,\, \rev,\, \rcoev)$ 
    ...
    \begin{itemize}
        \item $\Cat{C}$ の対象 $m \in \Obj{\Cat{C}}$ 
        \item \textbf{左作用} (left action) と呼ばれる $\Cat{C}$ の射 $\rho \colon x_1 \otimes m \lto m$
