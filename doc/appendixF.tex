...
\begin{marker}
    ...
    \begin{itemize}
        ...
        \item \hyperref[def:bimodulecat]{$(\Cat{C}_1,\, \Cat{C}_2)$-加群圏} $(\Cat{M},\, \btr,\, \btl,\, \alpha,\, \beta,\, \lambda,\, \rho,\, b)$ のことを $\BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2}$ と書く．
    \end{itemize}
\end{marker}
...
\begin{mydef}[label=def:modulecat-exact,breakable]{完全な加群圏}
    ...
    \begin{itemize}
        ...
        \item \hyperref[def:finite-abcat]{局所有限}な\hyperref[def:bimodulecat]{$(\Cat{C}_1,\, \Cat{C}_2)$-加群圏} $\BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2}$
    \end{itemize}
...
\begin{mylem}[label=lem:exact-Fun]{}
    ...
    \begin{align}
        &\LModFun{\Cat{C}_1} (\LModCat{\Cat{M}_1}{\Cat{C}_1}, \LModCat{\Cat{M}_2}{\Cat{C}_1}), &&\RModFun{\Cat{C}_2} (\RModCat{\Cat{M}_1}{\Cat{C}_2},\, \RModCat{\Cat{M}_2}{\Cat{C}_2}), &&\BiModFun{\Cat{C}_1}{\Cat{C}_2} (\BiModCat{\Cat{M}_1}{\Cat{C}_1}{\Cat{C}_2},\, \BiModCat{\Cat{M}_2}{\Cat{C}_1}{\Cat{C}_2})
    \end{align}
    の全てについて以下が成り立つ：
    \begin{enumerate}
...
\begin{myprop}[label=prop:module-End]{{$\Fun(\Cat{M},\, \Cat{M})$} の多重テンソル圏としての構造}
    ...
    を与える．このとき，3つの $(1,\, 1)$-圏
    \begin{align}
        &\LModFun{\Cat{C}_1} (\LModCat{\Cat{M}}{\Cat{C}_1}, \LModCat{\Cat{M}}{\Cat{C}_1}), &&\RModFun{\Cat{C}_2} (\RModCat{\Cat{M}}{\Cat{C}_2},\, \RModCat{\Cat{M}}{\Cat{C}_2}), &&\BiModFun{\Cat{C}_1}{\Cat{C}_2} (\BiModCat{\Cat{M}_1}{\Cat{C}_1}{\Cat{C}_2},\, \BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2})
    \end{align}
    の全てについて以下が成り立つ：
    \begin{enumerate}
...
\begin{proof}
    ...
    \begin{enumerate}
        \item 合成の\hyperref[def:category]{結合則}から明らか．
        \item 補題\ref{lem:exact-Fun}-(1) より，任意の対象 $F$ に対して常にその左随伴 $F^* \dashv F$ が存在する．
        ...
        \end{align}
        が成り立つ．故に\hyperref[col:Yoneda]{米田の補題}から自然同型 $F^* (x \btr n) \cong x \btr F^*(n)$ が存在し，$F \in \LModFun{\Cat{C}} (\LModCat{\Cat{M}}{\Cat{C}},\, \LModCat{\Cat{M}}{\Cat{C}})$ であることが分かった．        
        % counit / unit of adjunction が取れる．
        \hyperref[redef:monoidal-category]{\textsf{\textbf{(zig-zag equiations)}}}はtriangle identity より明らか．
...
\begin{mydef}[label=def:module-End]{双対テンソル圏}
    ...
    \begin{align}
        \LModEnd{\Cat{C}_1} (\LModCat{\Cat{M}}{\Cat{C}_1})&\coloneqq \LModFun{\Cat{C}_1} (\LModCat{\Cat{M}}{\Cat{C}_1}, \LModCat{\Cat{M}}{\Cat{C}_1}), \\
        \RModEnd{\Cat{C}_2} (\RModCat{\Cat{M}}{\Cat{C}_2})&\coloneqq \RModFun{\Cat{C}_2} (\RModCat{\Cat{M}}{\Cat{C}_2},\, \RModCat{\Cat{M}}{\Cat{C}_2}),\\ 
        \BiModEnd{\Cat{C}_1}{\Cat{C}_2} (\BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2}) &\coloneqq \BiModFun{\Cat{C}_1}{\Cat{C}_2} (\BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2},\, \BiModCat{\Cat{M}}{\Cat{C}_1}{\Cat{C}_2})
    \end{align}
