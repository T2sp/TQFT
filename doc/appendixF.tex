...
\begin{proof}
    ...
    \begin{align}
        ...
        \end{tikzpicture}
    \end{align}
    であるから，$\otimes$ が\hyperref[def:functor]{関手}であること\footnote{従って，$\Id$ を適当に挿入することで，ストリングを上下に自由自在に伸縮させることができる！}\hyperref[redef:dual]{\textsf{\textbf{(zig-zag equiations)}}}より
    \begin{align}
        \beta \circ \alpha &= 
        \begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)}]
            \path coordinate (x_1)
...
\begin{mydef}[label=def:Drinfeld-center]{Drinfeld中心}
    ...
    \begin{itemize}
        ...
        \begin{align}
            &\Hom{\Dri{\Cat{C}}} \bigl( (Z,\, \gamma_Z),\, (W,\, \gamma_W) \bigr) \\
