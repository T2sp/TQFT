...
\begin{myexample}[label=ex:Map-m1]{集合 {$M^{m,\, 1}_K$}}
    ...
    \begin{align}
        M^{m,\, 1}_K = \Bigl\{\, (\sigma_0,\, \dots,\, \sigma_m) \in K_{m+1}^{\times (m+1)} \Bigm| \substack{1 \le \forall k \le m,\; \partial^{m+1}_k (\sigma_k) = \partial^{m+1}_k (\sigma_{k-1}) \\ \partial^{m+1}_{m+1} (\sigma_m) = x_0,\; \partial^{m+1}_0 (\sigma_0) = x_1} \,\Bigr\} 
    \end{align}
