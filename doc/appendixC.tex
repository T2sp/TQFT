...
\begin{myexample}[label=ex:Map2]{射の空間の2-射}
    ...
    \begin{align}
        \label{eq:Map2}
        \inftyMap{K}(x,\, y)_2 \cong \Bigl\{\, (t_0,\, t_1,\, t_2) \in K_3^{\times 3} \Bigm| \substack{\partial^3_1(t_0) = \partial^3_1(t_1),\; \partial^3_2(t_1) = \partial^3_2(t_2) \\ \partial^3_0 (t_0) = \sigma^2_0(\Id_y),\; \partial^3_3 (t_2) = \sigma^2_0(\Id_x)} \,\Bigr\} 
    \end{align}
