...
\begin{proof}
    ...
    \begin{description}
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        $\Cat{C}$ は\hyperref{groupoid}なので，この図式に $\sigma_0 \coloneqq \sigma_1 \circ \sigma_2 \in \mathrm{N}(\Cat{C})_1$ を付け足すことで所望の $\bar{\sigma} \in \mathrm{N}(\Cat{C})_2 \cong \Hom{\SimpSet} \bigl(\Delta^2,\, \mathrm{N}(\Cat{C})\bigr)$ を得る．
