...
\begin{mydef}[label=def:enriched,breakable]{豊穣圏}
    ...
    \begin{description}
        ...
        \begin{center}
            \begin{tikzcd}
                &\bigl( \Hom{\Cat{C}}(x,\,  y) \otimes \Hom{\Cat{C}}(y,\,  z) \bigr) \otimes \Hom{\Cat{C}}(z,\,  w) \ar[rr, "\cong"]\ar[d,"\circ_{x,y,z} \otimes \Id_{\Hom{\Cat{C}}(z,\,  w)}"'] & &\Hom{\Cat{C}}(x,\,  y) \otimes \bigl( \Hom{\Cat{C}}(y,\,  z) \otimes \Hom{\Cat{C}}(z,\,  w) \bigr) \ar[d, "\Id_{\Hom{\Cat{C}}(x,\,  y)} \otimes \circ_{y,z,w}"] \\
                &\Hom{\Cat{C}} (x,\,  z) \otimes \Hom{\Cat{C}}(z,\,  w) \ar[r, "\circ_{x,z,w}"]  &\Hom{\Cat{C}}(x,\,  w) &\Hom{\Cat{C}}(x,\,  y) \otimes \Hom{\Cat{C}}(y,\,  w) \ar[l,"\circ_{x,y,w}"']
            \end{tikzcd}
        \end{center}
