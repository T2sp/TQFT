...
\begin{mydef}[label=def:unit-counit-adjunction,breakable]{unit / counit of adjunction}
    ...
    \begin{enumerate}
        \item $\forall x \in \Obj{\Cat{C}}$ に対して
        \begin{align}
            \eta_x \coloneqq \widetilde{\Id_{F(x)}} \in \Hom{\Cat{C}} \bigl( x,\, G \circ F(x) \bigr)
        \end{align}
        とおく．これは自然変換
        \begin{align}
            \eta \coloneqq \Familyset[\big]{\eta_x}{x \in \Obj{\Cat{C}}} \colon \Id_{\Cat{C}} \Longrightarrow G \circ F
        \end{align}
        を成し，\textbf{unit of adjunction} と呼ばれる．
        \item $\forall y \in \Obj{\Cat{C}}$ に対して
        \begin{align}
            \epsilon_y \coloneqq \widetilde{\Id_{G(y)}} \in \Hom{\Cat{C}} \bigl( F \circ G (y),\, y \bigr)
        \end{align}
        とおく．これは自然変換
        \begin{align}
            \epsilon \coloneqq \Familyset[\big]{\epsilon_y}{y \in \Obj{\Cat{C}}} \colon F \circ G \Longrightarrow \Id_{\Cat{D}}
        \end{align}
        を成し，\textbf{counit of adjunction} と呼ばれる．
    \end{enumerate}
\end{mydef}
