...
\begin{mydef}[label=def:infty-operad,breakable]{{$(\infty,\, 1)$}-オペラッド}
    ...
    \begin{description}
        ...
        \footnote{つまり，これは $(\bar{\rho}^1,\, \dots,\, \bar{\rho}^n) \in \prod_{i=1}^n \inftyMap{\Cat{O}^\otimes} (y,\, y_i)_0$ による\hyperref[def:Map-comp]{前合成}である．この関手は up to homotopy でしか定まらないのだった．}
        \begin{align}
