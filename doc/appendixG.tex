...
\begin{mydef}[label=def:Bsc-induction,breakable]{圏 $\Bsc_{\le k+1,\, \le \infty}$}
    ...
    \begin{description}
        ...
        \footnote{\exref{ex:depth-Cone}より，$(Z \to P) \in \Obj{\SnglrC_{\le k,\, \le \infty}}$ であることが分かる．} $U^n_Z \in \Obj{\SnglrC_{\le k+1,\, \le \infty}}$ および，極大アトラス $\mathcal{A}_Z \in \Obj{\Sm_{\textcolor{red}{\le k},\, \le \infty} (Z \to P)}$ の組み
        \begin{align}
            (U^n_Z,\, \mathcal{A}_Z)
        \end{align}
        を対象とする．
