...
\begin{align}
    ...
    \bigl\{\, ([U],\, [V]) \in \Obj{[\BSC]}^{\times 2} \bigm| \Hom{\Bsc} (U,\, V) \neq \empty \,\bigr\} 
\end{align}
が定まる．
...
\begin{mytheo}[label=thm:basic-easy]{Basics are easy}
    \begin{enumerate}
        ...
        \end{enumerate}
        \item 集合 $\Obj{[\BSC]}$ 上の2項関係\eqref{eq:relation-Bsc}は半順序である．半順序集合 $\Obj{[\BSC]}$ を $(1,\, 1)$-圏と見做し，それを $[\BSC]$ と書く．
        \item \hyperref[def:infinity-1]{$(\infty,\, 1)$-圏の関手}
        \begin{align}
            [\mhyphen] \colon \BSC \lto \Ner{[\BSC]}
        \end{align}
