...
\begin{proof}
    ...
    \begin{description}
        ...
        \begin{align}
            ...
            &= \Bigl( x,\, \bigl( \lim_{r \to +0} \tilde{\gamma}_{1,\, \frac{f_x|_{\mathbb{R}^n} (rp(x))}{r}} \bigr) \circ \bigl(\lim_{s \to +0} \tilde{\gamma}_{\frac{1}{s},\, 0} \circ \tilde{\gamma}_{1,\, - f_x|_{\mathbb{R}^n} (sp(x))} \circ f_x{}_{\Delta} \circ \tilde{\gamma}_{t(x) s,\, sp(x)} \bigr)(u) \Bigr)  \\
