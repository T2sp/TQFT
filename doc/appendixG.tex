...
\begin{proof}
    ...
    \begin{description}
        ...
        が言える．故に，
        \begin{align}
            \mathrm{proj}_{\Cone{Z}} \circ T \bigl( x,\, (v,\, [s,\, z]) \bigr) \eqqcolon \bigl[ T^{\mathbb{R}_{\ge 0}}_{x,\, v,\, [s,\, z]},\, T^Z_{x,\, v,\, [s,\, z]} \bigr] \in \Cone{Z}
        \end{align}
        とおくと
        \begin{align}
        ...
        \begin{align}
            ...
            &= \cdots \\
            &= \Bigl( x,\, \bigl( \lim_{r \to +0} \tilde{\gamma}_{1,\, \frac{f_x|_{\mathbb{R}^n} (rp(x))}{r}} \bigr) \circ \bigl(\lim_{s \to +0} \tilde{\gamma}_{\frac{1}{s},\, 0} \circ \tilde{\gamma}_{1,\, - f_x (sp(x))} \circ f_x{}_{\Delta} \circ \tilde{\gamma}_{t(x) s,\, sp(x)} \bigr)(u) \Bigr)  \\
