...
\begin{proof}
    ...
    \begin{description}
        ...
        \begin{align}
            ...
            &= \Bigl( x,\, \lim_{s \to +0} \tilde{\gamma}_{\frac{1}{s},\, 0} \circ f_x{}_\Delta \circ \tilde{\gamma}_{t(x)s,\,sp(x)} (u) \Bigr) \\
            &= \Bigl( x,\, \bigl( \lim_{s \to +0} \bigl(\tilde{\gamma}_{1,\, \frac{f_x|_{\mathbb{R}^n} (sp(x))}{s}}\circ \tilde{\gamma}_{1,\, - \frac{f_x|_{\mathbb{R}^n} (sp(x))}{s}}\bigr) \circ \tilde{\gamma}_{\frac{1}{s},\, 0} \circ f_x{}_{\Delta} \circ \tilde{\gamma}_{t(x) s,\, sp(x)} \bigr)(u) \Bigr)  \\
            &= \Bigl( x,\, \bigl( \lim_{r \to +0} \tilde{\gamma}_{1,\, \frac{f_x|_{\mathbb{R}^n} (rp(x))}{r}} \bigr) \circ \bigl(\lim_{s \to +0} \tilde{\gamma}_{1,\, - \frac{f_x|_{\mathbb{R}^n} (sp(x))}{s}} \circ \tilde{\gamma}_{\frac{1}{s},\, 0} \circ f_x{}_{\Delta} \circ \tilde{\gamma}_{t(x) s,\, sp(x)} \bigr)(u) \Bigr)  \\
            &= \Bigl( x,\, \bigl( \lim_{r \to +0} \tilde{\gamma}_{1,\, \frac{f_x|_{\mathbb{R}^n} (rp(x))}{r}} \bigr) \circ \bigl(\lim_{s \to +0} \tilde{\gamma}_{\frac{1}{s},\, 0} \circ \bigl( \lim_{a \to +0}\tilde{\gamma}_{1,\, - f_x|_{\mathbb{R}^n} (ap(x))} \circ f_x{}_{\Delta} \circ \tilde{\gamma}_{t(x) s,\, ap(x)}\bigr) \bigr)(u) \Bigr)  \\
        ...
        \end{align}
        が成り立つので，\hyperref[def:c-smooth-along]{微分}の一意性より $D_0 T = T$ だと分かる．i.e. $D_0 \circ i_2 = \Id_{\LGL(U)}$ である．
        ...
        \begin{align}
            ...
            f &\lmto \gamma_{[m]}{}_{1,\, - \mathrm{proj}_{\mathbb{R}^n} \circ f|_{\Delta^m_e \times \{0\}}} \circ f
        \end{align}
        である．
    \end{description}
\end{proof}
