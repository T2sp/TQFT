...
\begin{proof}
    ...
    \begin{description}
        ...
        $\bigl( x,\, (v,\, [s,\, z]) \bigr) = \gamma_{[m]}{}_{s,\, v} \bigl( x,\, (0,\, [1,\, z]) \bigr)$ が成り立つ\footnote{$(s,\, v) \in \Sing^{\text{sm}} (\mathbb{R}_{\ge 0} \times \mathbb{R}^n)$ とは，定数写像 $\Delta^m_e \lto \mathbb{R}_{\ge 0} \times \mathbb{R}^n,\; x \lmto (s,\, v)$ のことである．}ので，
        \begin{align}
            &T \bigl( x,\, (v,\, [s,\, z]) \bigr) \\
