...
\begin{proof}
    ...
    \end{align}
    と定めることで $T \in \Hom{\BSC}^0 (U,\, U)_m$ と見做せる．このとき，$\forall (t,\, p) \in \Sing^{\text{sm}} (\mathbb{R}_{\ge 0} \times \mathbb{R}^n)$ に対して
    \begin{align}
        ...
        &= \gamma_{[m]}{}_{t,\, Ap} \Bigl( x,\, \bigl( A(x)v,\, [s,\, \mathrm{proj}_Z \circ f(x,\, z)] \bigr) \Bigr) \\
...
\begin{proof}
    \begin{description}
        ...
        \end{align}
        が定まることを示そう．
        実際，$\forall (t,\, p) \in \Sing^{\text{sm}} (\mathbb{R}_{\ge 0} \times \mathbb{R}^n)_m$ に対して
        \begin{align}
            D_{(x,\, 0)} f \circ \gamma_{[m]}{}_{t,\, p}
            &= \Bigl( \lim_{s \to +0} \gamma_{\frac{1}{s},\, 0} \circ f \circ \gamma_{s,\, 0}  \Bigr) \circ \gamma_{t,\, p} \\
            &= \cdots \\
            &= \gamma_{[m]}{}_{t,\, D_{(x,\, 0)} f(p)} \circ D_{(x,\, 0)} f
        \end{align}
        と計算できる．
