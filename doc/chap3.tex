...
\begin{description}
    ...
    　ここで，$\forall x \in \mathsf{V}\bigl(\mathrm{Lk}(v;\, P)\bigr)$ に対して勝手な $\alpha_x \in \expval{\Gamma(a_1)^{\varepsilon_{a_1}},\, \dots,\, \Gamma(a_m)^{\varepsilon_{a_m}}} \eqqcolon \mathcal{H}\bigl(\mathrm{Lk}(v;\, P);\, \Gamma\bigr)$ を割り当てることで，絡みグラフ $\mathrm{Lk}(v;\, P) \subset \partial B_v$ をストリング図式に読み替える．
