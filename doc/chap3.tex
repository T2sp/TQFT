...
さらにこの主束は被覆空間になるので，$\forall \sigma \in \Hom{\PATH{\mfdcal{M}{d}}}(x,\, x)$ は $x$ のファイバー内の点 $u \in \pi^{-1}(\{x\})$ について一意的に $\tilde{\sigma} \in \Hom{\PATH{P}}(u,\, \tilde{\sigma}(1))$ へ持ち上がり，$\tilde{\sigma}(1) \eqqcolon \tilde{\sigma}(0) \btl \gamma_P(\sigma)$ 
