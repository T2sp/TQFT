...
\begin{mydef}[label=def:dual,breakable]{双対}
    ...
    \begin{description}
        ...
        \begin{center}
            \begin{tikzcd}[row sep=large, column sep=large]
                &X \otimes I \ar[dddd, "r_X"]\ar[drr, "1_X \otimes i_x"]& & \\
                & & &X \otimes (X^* \otimes X) \ar[d, "a_{X,\, X^*,\, X}^{-1}"] \\
                & & &(X \otimes X^*) \otimes X \ar[d, "e_X \otimes 1_X"] \\
                & & &I \otimes X \ar[dll, "l_X"] \\
                &X & &
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd}[row sep=large, column sep=large]
                &I \otimes X^* \ar[dddd, "l_{X^*}"]\ar[drr, "i_X \otimes 1_{X^*}"]& & \\
                & & &(X^* \otimes X) \otimes X^* \ar[d, "a_{X^*,\, X,\, X^*}"] \\
                & & &X^* \otimes (X \otimes X^*) \ar[d, "1_{X^*} \otimes e_X"] \\
                & & &X^* \otimes I \ar[dll, "r_{X^*}"] \\
                &X^* & &
            \end{tikzcd}
        \end{center}
    \end{description}
...
\begin{description}
    ...
    $\Sigma$ の逆の向きを $\Sigma^*$ と書く\footnote{\exref{ex:Cob-closed}の意味で $\Sigma$ の双対となっている．}とき，$V(\Sigma^*) = V(\Sigma)^*$ を充たす\footnote{$V(\Sigma)$ が有限次元なので，$V(\Sigma)^*$ はブラ空間と見做せる．}．
