...
\begin{mylem}[label=lem:trivalent-Lk]{三角形分割の絡みグラフと $F$-シンボル}
    \begin{align}
        ...
        \end{tikzpicture}
        &= (F^{xyz}_u)_{(\textcolor{red}{a};\, \textcolor{red}{\varphi_1{}_{\mu_1}},\, \textcolor{red}{\varphi_2{}_{\mu_2}}),\, (\textcolor{blue}{b};\, \textcolor{blue}{\varphi_3{}_{\mu_3}},\, \textcolor{blue}{\varphi_4{}_{\mu_4}})}
    \end{align}
...
\begin{proof}
    ...
    \begin{align}
        \begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)}]
            ...
            \draw[->-=.5,blue] (z) -- node[midway,right] {$z$} (f_4);
            \draw[->-=.5,blue] (y) -- node[midway,left] {$y$} (f_4);
            \node[circlenode] at (f_3) {$\textcolor{blue}{\varphi_3{}^{\mu_3}}$};
            \node[circlenode] at (f_4) {$\textcolor{blue}{\varphi_4{}^{\mu_4}}$};
        \end{tikzpicture}
    \end{align}
    を合成して\hyperref[def:trace]{トレース}をとると，
\end{proof}
