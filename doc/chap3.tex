...
\begin{proof}
    ...
    \begin{align}
        &\abs{M_1 \circ M_0;\, G_0,\, G_1;\, \{x^0_e\},\, \{x^1_e\}} \\
        &= \frac{\dim(\Cat{C})^{\abs{\Sigma_1 \setminus G_1}}}{\displaystyle\prod_{e \in \mathsf{E} (G_1)} \dim (x_e)} \dim(\Cat{C})^{-\abs{M_1 \circ M_0 \setminus P}}  \\
        &\qquad \times \sum_{\substack{\Gamma \colon \mathrm{Reg}(P) \lto \Simp(\Cat{C}), \\ \Gamma|_{\partial P} = \{x^0_e\} \cup \{x^1_e\}}} \left(Z(\Gamma;\, P) \prod_{R \in \mathrm{Reg}(P)} \dim \bigl( \Gamma(R) \bigr)^{\chi(R)}\right) \\
        &= \frac{\dim(\Cat{C})^{\abs{\Sigma_1 \setminus G_1}}}{\displaystyle\prod_{e \in \mathsf{E} (G_1)} \dim (x_e)} \dim(\Cat{C})^{-\abs{M_0 \setminus P_0} - \abs{M_1 \setminus P_1} + \abs{\Sigma \setminus G}}  \\
        ...
        &\qquad \times \left(Z(\Gamma_1;\, P_1) \circ Z(\Gamma_0;\, P_0) \frac{\prod_{R_0 \in \mathrm{Reg}(P_0)} \dim \bigl( \Gamma_0(R) \bigr)^{\chi(R_0)} \prod_{R_1 \in \mathrm{Reg}(P_1)} \dim \bigl( \Gamma_1(R) \bigr)^{\chi(R_1)}}{\prod_{e \in \mathsf{E}(G)} \dim \bigl( \Gamma(R_e) \bigr)}\right) \\ 
        &= \sum_{\{\Gamma (R_e)\}} \left( \frac{\dim(\Cat{C})^{\abs{\Sigma_1 \setminus G_1}}}{\prod_{e \in \mathsf{E} (G_1)} \dim (x_e)} \dim(\Cat{C})^{-\abs{M_1 \setminus P_1}}\sum_{\Gamma_1} Z (\Gamma_1;\, P_1) \prod_{R_1 \in \mathrm{Reg}(P_1)} \dim \bigl( \Gamma_1(R) \bigr)^{\chi(R_1)} \right) \\
        &\qquad \circ \left( \frac{\dim(\Cat{C})^{\abs{\Sigma \setminus G}}}{\prod_{e \in \mathsf{E} (G)} \dim \bigl( \Gamma (R_e) \bigr) } \dim(\Cat{C})^{-\abs{M_0 \setminus P_0}} \sum_{\Gamma_0} Z (\Gamma_0;\, P_0) \prod_{R_0 \in \mathrm{Reg}(P_0)} \dim \bigl( \Gamma_0(R) \bigr)^{\chi(R_0)} \right) \\
        &= \sum_{\{x_e\}_{e \in \mathsf{E}(G)}} \abs{M_1;\, G,\, G_1;\, \{x_e\},\, \{x^1_e\}} \circ \abs{M_0;\, G_0,\, G;\, \{x^0_e\},\, \{x_e\}}
    \end{align}
    が言えた．
\end{proof}
