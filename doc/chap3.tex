...
Turaev-Viroが最初に発見したTQFTは，多様体 $M$ の\hyperref[def:polytope-decomp]{多面体分割} $(P,\, P^{(1)})$ として多面体分割をとる場合のものであった~\cite{TuraevViro1992TQFT}．
...
いま，$\forall a,\, b,\, c \in \Simp(\Cat{C})$ に対して，有限次元 $\mathbb{K}$-ベクトル空間 $\Hom{\Cat{C}} (a,\, b \otimes c)$ の基底を1つ選んできて固定する．それを $\bm{\Basis (a,\, b \otimes c)}$ と書く．
