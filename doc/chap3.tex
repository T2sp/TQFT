...
\begin{center}
    ...
    \end{tikzcd}
\end{center}
のようになっている．ここに $(A,\, g) \in \mathrm{Del}^2(\mfdcal{M},\, \underline{\Omega^\bullet(\mhyphen,\, \mathfrak{g})})$ である．
...
\begin{align}
    ...
    \irm{BG}{flat} \xleftrightarrow{1:1} \mathrm{Bun}_G (\mfdcal{M}{d})/\cong \xleftrightarrow{1:1} \comm{\mfdcal{M}{d}}{BG}
\end{align}
...
\begin{align}
    \irm{\bm{\mathrm{B}}G}{conn} = \irm{\bm{\mathrm{B}}G}{flat} \xleftrightarrow{1:1} \mathrm{Bun}_G (\mfdcal{M}{d})/\cong = \Hom{\mathrm{\bm{H}}} (\mfdcal{M}{d},\, \mathrm{\bm{B}}G)
\end{align}
