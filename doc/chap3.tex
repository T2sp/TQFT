...
\end{itemize}
によって定義する\footnote{これのHom集合を\textbf{thin homotopy}と呼ばれる同値関係で割ることで得られる\hyperref[def:groupoid]{groupoid}のことを\textbf{path groupoid}と呼ぶ（\url{https://ncatlab.org/nlab/show/path+groupoid}）．}．
