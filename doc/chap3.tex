...
エニオンのフュージョン則を議論する前に少し寄り道をして，\cite{hidaka2022g-sym}に倣って\textbf{一般化対称性} (generalized symmetry)\footnote{\textbf{高次対称性} (higher form symmetry) と呼ばれることもある．} の話をする．
この節では自然単位系を使う．
...
\begin{myexample}[label=ex:3-2]{$3+1$ 次元 $\LU(1)$ ゲージ理論}
    ...
    \begin{align}
        ...
        & \lmto \exp \left( \iunit \int_C a - \iunit \theta\, \Link(S,\, C) \right) \\
