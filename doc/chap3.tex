...
\begin{mylem}[label=lem:trinvalent-fusion,breakable]{梯子型ストリング図式の計算}
    \begin{itemize}
...
いま，$\forall a,\, b,\, c \in \Simp(\Cat{C})$ に対して，$\mathbb{K}$-ベクトル空間 $\Hom{\Cat{C}} (a,\, b \otimes c)$ の基底を1つ選んできて固定する．それを $\mathrm{Basis} (a,\, b \otimes c)$ と書く．
