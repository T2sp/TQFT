...
\begin{proof}
    \begin{enumerate}
        ...
        \begin{proof}
            ...
            \end{align}
            になる．さらに，\hyperref[def:tensorial-form]{tensorial form of type $\rho$ の定義}から，$\forall \psi \in \Omega^k_\rho (P;\, V)$ は水平でかつ $\forall g \in G$ に対して $R_g^* \psi = \rho(g^{-1})(\phi) = \phi$ を充たす．
        \end{proof}
        \hrulefill
