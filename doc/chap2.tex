...
しばらくの間Lie群 $G$ （もしくはその部分群）のLie代数を $\mathrm{Lie}(G) \coloneqq \mathfrak{g}$ と書くことにする\footnote{例えば~\cite{Lee2012smooth}では，$\mathrm{Lie}(G) \coloneqq \Lie{\mathfrak{X}}(G)$ と定義ているので注意．同型なのでそこまで問題にはならないが...}．
