...
\begin{mydef}[label=def:n-cond]{{$n$}-condensation}
    ...
    \begin{itemize}
        \item A 1-morphism $f \in \inftyMap{\Cat{C}} (x,\, y)_0$
        \item A 1-morphism $g \in \inftyMap{\Cat{C}} (y,\, x)_0$
        \item An $(n-1)$-condensation of $f \circ g$ onto $\Id_y$ in $\inftyMap{\Cat{C}} (y,\, y)$\footnote{Roughly speaking, a mapping space $\inftyMap{\Cat{C}} (y,\, y)$ itself is an $(n-1,\, n-1)$-category. Strickly speaking, we need enriched $\infty$-category theory.} 
...
\begin{myexample}[label=def:1-cond]{1-condensation}
    ...
    \begin{itemize}
        \item A 1-morphism $f \in \Hom{\Cat{C}} (x,\, y)$
        \item A 1-morphism $g \in \Hom{\Cat{C}} (y,\, x)$
        \item A 0-condensation of $f \circ g$ onto $\Id_y$ in $\Hom{\Cat{C}} (y,\, y)$. 
        i.e. $f \circ g = \Id_y$
    \end{itemize}
\end{myexample}
...
\begin{myexample}[label=def:2-cond]{2-condensation}
    ...
    \begin{itemize}
        \item A 1-morphism $f \in \inftyMap{\Cat{C}} (x,\, y)_0$
        \item A 1-morphism $g \in \inftyMap{\Cat{C}} (y,\, x)_0$
        \item A 1-condensation of $f \circ g$ onto $\Id_y$ in $(1,\, 1)$-category $\inftyMap{\Cat{C}} (y,\, y)$.
    \end{itemize}
    By \exref{def:1-cond}, 
    \begin{itemize}
        \item A 1-morphism $f \in \inftyMap{\Cat{C}} (x,\, y)_0$
        \item A 1-morphism $g \in \inftyMap{\Cat{C}} (y,\, x)_0$
        \item A 2-morphism (in $\Cat{C}$) $(f \circ g \xrightarrow{\varphi} \Id_y) \in \inftyMap{\Cat{C}} (y,\, y)_1$
        \item A 2-morphism (in $\Cat{C}$) $(\Id_y \xrightarrow{\psi} f \circ g) \in \inftyMap{\Cat{C}} (y,\, y)_1$
        \item An equality $\varphi \circ \psi = \Id_{\Id_y}$
    \end{itemize}
\end{myexample}
...
\begin{myexample}[label=def:3-cond]{3-condensation}
    ...
    \begin{itemize}
        \item A 1-morphism $f \in \inftyMap{\Cat{C}} (x,\, y)_0$
        \item A 1-morphism $g \in \inftyMap{\Cat{C}} (y,\, x)_0$
        \item A 2-morphism $(f \circ g \xrightarrow{\varphi} \Id_y) \in \inftyMap{\Cat{C}} (y,\, y)_1$
        \item A 2-morphism $(\Id_y \xrightarrow{\psi} f \circ g) \in \inftyMap{\Cat{C}} (y,\, y)_1$
        \item A 3-morphism
        \begin{align}
            \left(
            \begin{tikzcd}[
                ...
                {\Id_y} \arrow[r, "\varphi \circ \psi", bend left, shift left, ""{name=U, below}] \arrow[r, "{\Id_{\Id_y}}"', bend right, shift right,""{name=D, above}] \& {\Id_y}
        ...
        \begin{align}
            ...
            \begin{tikzcd}[
                ...
                {\Id_y} \arrow[r, "{\Id_{\Id_y}}", bend left, shift left, ""{name=U, below}] \arrow[r, "\varphi \circ \psi"', bend right, shift right,""{name=D, above}] \& {\Id_y}
        ...
        \begin{align}
            ...
            \begin{tikzcd}[
                ...
                \Id_y \arrow[rr, "\Id_{\Id_y}", bend left=49, shift left=2, ""{name=U,below}] \arrow[rr, "\varphi \circ \psi" description,""{name=MU,above},""{name=MD,below}] \arrow[rr, "\Id_{\Id_y}"', bend right=49, shift right=2,""{name=D,above}] \&  \& \Id_y
...
Roughly speaking, a \textbf{walking} $\bm{n}$\textbf{-condensation} is a (strict?) $n$-category $\clubsuit_n$ which ``generates" \hyperref[def:n-cond]{$n$-condensation} in $\Cat{C}$.
...
Let $\clubsuit_n \subset \spadesuit_n$ be a full-subcategory which consists of walking $n$-condensations on only one points.
